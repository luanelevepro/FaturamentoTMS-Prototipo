          ...
          {expandedDeliveryId === del.id && (
              <div className="animate-in slide-in-from-top-2 border-t border-gray-100 bg-gray-50/30">
                  <div className="p-5 space-y-3">
                      {groups.length === 0 && semCte.length === 0 ? (
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest border ${
                      newLoadTab === 'CARGAS' ? 'bg-black text-white border-black' : 'bg-white text-gray-600 border-gray-200'
                    }`}
                  >
                    Cargas
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest border ${
                      newLoadTab === 'DOCUMENTOS' ? 'bg-black text-white border-black' : 'bg-white text-gray-600 border-gray-200'
                    }`}
                  >
                    Documentos
                  </button>
                    ...
                    return filtered.map(l => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-lg mb-2 border cursor-pointer transition-all ${
                            isSelected ? 'bg-blue-50 border-blue-500 ring-1 ring-blue-500' : 'bg-white border-gray-200 hover:border-gray-400'
                          }`}
                        >
