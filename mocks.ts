    ...
    legs: [
      {
        ...
        deliveries: [
          {
            id: 'del-1', sequence: 1, destinationCity: 'Florianópolis, SC', destinationAddress: 'Loja Central', recipientName: 'Mercado Livre', status: 'Pending',
            documents: [
    ...
    legs: [
      {
        ...
        deliveries: [
          {
            id: 'del-1002-1', sequence: 1, destinationCity: 'Rio de Janeiro, RJ', destinationAddress: 'Centro de Distribuição Norte', recipientName: 'Amazon Logística', status: 'Pending',
            documents: [
    ...
    legs: [
      {
        ...
        deliveries: [
          {
            id: 'del-1003-1', sequence: 1, destinationCity: 'Brasília, DF', destinationAddress: 'Shopping Sul', recipientName: 'Riachuelo S/A', status: 'Pending',
            documents: [
    ...
    legs: [
      {
        ...
        deliveries: [
          {
            id: 'del-1004-1', sequence: 1, destinationCity: 'Recife, PE', destinationAddress: 'Ind. Química', recipientName: 'Braskem', status: 'Delivered',
            documents: [
